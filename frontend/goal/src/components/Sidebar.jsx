...
import { Briefcase, Users, Shield, LogOut } from 'lucide-react';
...
export default function Sidebar({ isOpen, onClose }) {
  ...
  return (
    <>
      ...
      <aside className={`fixed top-0 bottom-0 left-0 z-50 w-64 bg-slate-950 text-slate-200 flex flex-col border-r border-slate-900 shadow-2xl transition-transform duration-300 ease-in-out font-sans ${
